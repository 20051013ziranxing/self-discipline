...
public class CheckInBean {
    ...
    public List<CheckinData> getData() {
        return data;
    }

    public void setData(List<CheckinData> data) {
        this.data = data;
    }
    ...
    public class DecodedCheckinCount {
        private Map<String, Integer> decodedMap;

        public Map<String, Integer> getDecodedMap() {
            return decodedMap;
        }
        public int getCount(String key) {
            return decodedMap.get(key);
        }

        public void setDecodedMap(Map<String, Integer> decodedMap) {
